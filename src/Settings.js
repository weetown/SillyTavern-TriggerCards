...
export class Settings {
    ...
    /**@type {()=>void} */ onRestart;
    /**@type {(changedKeys:string[])=>void} */ onLiveUpdate;
    /**@type {()=>void} */ onShow;
    /**@type {()=>void} */ onHide;
    ...
    registerSettings() {
        ...
        if (this.showMembersSection) { // members
            ...
            this.settingList.push(CheckboxSetting.fromProps({ id: 'sttc--dragReorder',
                ...
                onChange: (it)=>{ this.enableDragReorder = it.value; this.save({ changed: ['enableDragReorder'] }); },
            }));
        }
        { // images
        ...
        { // layout
            ...
            this.settingList.push(CheckboxSetting.fromProps({ id: 'sttc--showNametags',
                ...
                onChange: (it)=>{ this.showNametags = it.value; this.save({ changed: ['showNametags'] }); },
            }));
            ...
            this.settingList.push(SelectSetting.fromProps({ id: 'sttc--nametagPosition',
                ...
                onChange: (it)=>{ this.nametagPosition = it.value; this.save({ changed: ['nametagPosition'] }); },
            }));
    ...
    save(options = false) {
        ...
        if (typeof options === 'boolean') {
            ...
            isRestart = Boolean(options.restart);
            changedKeys = Array.isArray(options.changed) ? options.changed : [];
        }

        saveMetadataDebounced();
        this.onLiveUpdate?.(changedKeys);
        if (isRestart) {
            this.onRestart?.();
        }
    }
